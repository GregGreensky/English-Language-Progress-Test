...
namespace TestyDbTryout
{
    ...
    public class DatabaseHandler : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            string connect = "Data Source=************;Initial Catalog=testy;Persist Security Info=True;User ID=********Password=******;Pooling=False;MultipleActiveResultSets=False;Encrypt=False;TrustServerCertificate=True";
